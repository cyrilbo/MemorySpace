...
const DEFAULT_WIDTH = 902.567;
const DEFAULT_HEIGHT = 748.955;

interface Props {
  width: number;
}

export const SuccessIllustration: FunctionComponent<Props> = ({ width }) => {
  return (
    <Svg
      width={width}
      ...
      <G data-name="Group 22" transform="translate(-282 -122.601)">
        ...
        <G data-name="Group 1" transform="translate(312.096 220.737)">
          ...
          <Path
            ...
            fill="#000000"
          />
          <Path data-name="Rectangle 82" fill="#2f2e41" d="M154.665 40.309h99.6v118.104h-99.6z" />
        ...
        <Path
          ...
          fill="#efefef"
        />
        <Path data-name="Rectangle 22" fill="#2f2e41" d="M282 868.689h902.567v1.821H282z" />
        <Path
          data-name="Path 177"
